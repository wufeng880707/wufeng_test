...
#import "WF_ActionSheet.h"
#import "WF_ActionSheet.h"
#import "UIView+WFExtension.h"

@interface WF_ActionSheet () {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(WF_actionSheet:clickedItem:atIndex:)]) {
        [self.delegate WF_actionSheet:self clickedItem:item atIndex:indexPath];
    }
